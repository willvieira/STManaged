...
First we need to define the number of steps we want the model to run. Note that one time step in the model means 5 years of forest dynamics. So let's set the model to run for 500 years:
