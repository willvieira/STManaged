...
#' @param occup numeric between 0 and 1, if \code{occup} is not \code{NULL}, the animation will include two lines to define the south range limit of boreal and the north range limit of temperate. \code{occup} define the amount of occupancy a forest state must not occupy to determine the limit of its range distribution
